...
class Interceptor extends \Magento\Customer\Block\Adminhtml\Edit\Tab\Newsletter implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getTabClass()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getTabClass', func_get_args(), $pluginInfo) : parent::getTabClass();
    }
    ...
    public function getTabUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getTabUrl', func_get_args(), $pluginInfo) : parent::getTabUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAjaxLoaded');
        return $pluginInfo ? $this->___callPlugins('isAjaxLoaded', func_get_args(), $pluginInfo) : parent::isAjaxLoaded();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStatusChangedDate');
        return $pluginInfo ? $this->___callPlugins('getStatusChangedDate', func_get_args(), $pluginInfo) : parent::getStatusChangedDate();
    }
